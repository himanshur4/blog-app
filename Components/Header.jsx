    ...
    return (
        <div className='py-5 px-5 md:px-12 lg:px-28 text-primary'>
            <div className='flex justify-between items-center'>
                ...
                <Link href={'/admin/addProduct'} className='flex items-center gap-2 font-medium py-1 px-3 sm:py-3 sm:px-6 border border-solid border-black shadow-[-7px_7px_0px_#000000]'>Get started <Image src={assets.arrow} alt="arrow" /></Link>
            </div>
